# Patrones Unificados para Clasificación de Ansiedad y Depresión

## 📋 Propósito

Esta carpeta contiene **patrones léxicos unificados** que combinan los corpus CSJDM (Hospital Clínico San Juan de Dios) y HOMO (Hospital Oriente de Medellín) para la detección automática de fenotipos de ansiedad y depresión en textos clínicos en español.
